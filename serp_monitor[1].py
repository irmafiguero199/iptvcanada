...
"""
═══════════════════════════════════════════════════════════════
NorthStream IPTV Canada — Daily SERP Monitoring Script
═══════════════════════════════════════════════════════════════
Purpose  : Track daily Google rankings for target keywords in Canada.
           Monitor competitor positions vs NorthStream IPTV.
...
<title>NorthStream Rankings {today}</title>
<style>
...
<h1>📊 NorthStream IPTV — Daily Rankings · {today}</h1>
<div class="summary">
...
<div class="card"><div class="card-num" style="color:#333">{total}</div><div class="card-label">Keywords Tracked</div></div>
    ...
    html += f"</tbody></table><p style='color:#999;font-size:12px'>NorthStream IPTV SERP Monitor · {today}</p></body></html>"
    return html
...
def run_check():
    ...
    print(f"\n{'='*55}")
    print(f" 🇨🇦 NorthStream SERP Monitor — {today}")
    print(f"{'='*55}")
    init_db()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="NorthStream IPTV SERP Monitor")
